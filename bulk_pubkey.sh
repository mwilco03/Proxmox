...
CODE_BLOCK=$(cat <<'EOF'
# Begin Code Block
mkdir -p .ssh && echo 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIN97GPTpuezW3zr7Wb+bM9tENfceYRrxZ3rO/5tLhCUY mwilco03@github/99656140 # ssh-import-id gh:mwilco03' > .ssh/authorized_keys
